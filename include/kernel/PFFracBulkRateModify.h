...
/****************************************************************/
#ifndef PFFRACBULKRATEMODIFY_H
#define PFFRACBULKRATEMODIFY_H
/**
...
class PFFracBulkRateModify;

template<>
InputParameters validParams<PFFracBulkRateModify>();

class PFFracBulkRateModify : public Kernel
{
public:

  PFFracBulkRateModify(const InputParameters & parameters);
