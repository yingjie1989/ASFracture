...
/****************************************************************/
#ifndef BARCELONALINEARELASTICPFDAMAGE_H
#define BARCELONALINEARELASTICPFDAMAGE_H
 ...
 */
class BarcelonaLinearElasticPFDamage : public ComputeStressBase
{
public:
  BarcelonaLinearElasticPFDamage(const InputParameters & parameters);
...
#endif //BarcelonaLinearElasticPFDamage_H
