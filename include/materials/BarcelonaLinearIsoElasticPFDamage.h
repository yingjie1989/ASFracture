...
/****************************************************************/
#ifndef BARCELONALINEARISOELASTICPFDAMAGE_H
#define BARCELONALINEARISOELASTICPFDAMAGE_H
 ...
 */
class BarcelonaLinearIsoElasticPFDamage : public ComputeStressBase
{
public:
  BarcelonaLinearIsoElasticPFDamage(const InputParameters & parameters);
...
#endif //BARCELONALINEARISOELASTICPFDAMAGE_H
