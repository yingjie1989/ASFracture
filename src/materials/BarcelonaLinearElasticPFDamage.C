...
template<>
InputParameters validParams<BarcelonaLinearElasticPFDamage>()
{
...
BarcelonaLinearElasticPFDamage::BarcelonaLinearElasticPFDamage(const InputParameters & parameters) :
...
void
BarcelonaLinearElasticPFDamage::initQpStatefulProperties()
{
...
void BarcelonaLinearElasticPFDamage::computeQpStress()
{
