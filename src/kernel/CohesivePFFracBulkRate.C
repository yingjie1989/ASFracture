...
CohesivePFFracBulkRate::CohesivePFFracBulkRate(const InputParameters & parameters):
 ...
 _dG0_pos_dstrain(isParamValid("dG0_dstrain_var") ? &getMaterialProperty<RankTwoTensor>("dG0_dstrain_var"): NULL),
  ...
  _betaval_old(coupledValueOld("beta")),
...
Real
CohesivePFFracBulkRate::computeDFDOP(PFFunctionType type)
{
      ...
      Real x =   _c * _beta - _k - _dg_dphi * _psi_e;
...
Real
CohesivePFFracBulkRate::precomputeQpResidual()
{
...
Real
CohesivePFFracBulkRate::precomputeQpJacobian()
{
...
Real
CohesivePFFracBulkRate::computeQpOffDiagJacobian(unsigned int jvar)
{
