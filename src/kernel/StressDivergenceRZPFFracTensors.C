...
{
  InputParameters params = validParams<StressDivergenceRZTensors>();
...
StressDivergenceRZPFFracTensors::StressDivergenceRZPFFracTensors(const InputParameters & parameters) :
    DerivativeMaterialInterface<StressDivergenceRZTensors>(parameters),
...
Real
StressDivergenceRZPFFracTensors::computeQpOffDiagJacobian(unsigned int jvar)
{
  ...
  return StressDivergenceRZTensors::computeQpOffDiagJacobian(jvar);
}
